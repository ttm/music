...
s43_ = M.core.fade(sonic_vector=s43, duration=5, method='lin')
...
M.structures.symmetry.print_peal(pe3.act(), [0])
...
M.core.write_wav_mono(pcm_samples, 'something.wav')
