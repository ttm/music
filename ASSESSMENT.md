...
`music` 1.4.0: 47 modules, 11,734 LOC package + 9,311 LOC tests, 126 names
in the public API.*
...
|---|---|---|
| Test suite | `pytest -q` | **2375 tests**, 16 s |
...
| Lint, extended rule set | `ruff check --select ALL music` | 2,115 findings |
...
- **The extended lint set reports 2,115 findings** on `music/`, almost all
...
- **`legacy/` is 1,164 LOC** kept for `CanonicalSynth`, `IteratorSynth` and
